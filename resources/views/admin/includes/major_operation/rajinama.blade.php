{{-- this is for opration oper_rajinama info --}}
<h3 id="section_header3">राजिनामा विवरण</h3>
<div class="row">
    <div class="col-sm-2">
        <label for="name">राजिनामा निर्णय मिति : <sup>*</sup></label>
        <input type="text" class="form-control" name="oper_rajinama_appointed_date" nepali-calendar" id="nepaliDate14"
            placeholder="YYYY-MM-DD">
    </div>
    <div class="col-sm-2">
        <label for="name">सेवा :<sup>*</sup></label>
        <select readonly name="oper_rajinama_sewa" id="sewa_id" class="form-control  dynamic"
            data-dependent='oper_rajinama_samuha_id'>
    ...
    <div class="col-sm-2">
        ...
        <select readonly name="oper_rajinama_samuha" id="oper_rajinama_samuha_id" class="form-control  dynamic"
            data-dependent='oper_rajinama_upasamuha_id'>
            <option selected value="{{$employee[0]->samuha->id}}">{{$employee[0]->samuha->samuha_name}}</option>
        </select>
    </div>
    <div class="col-sm-2">
        <label for="name">उप-समुह :<sup>*</sup></label>
        <select readonly name="oper_rajinama_upasamuha" id="oper_rajinama_upasamuha_id" class="form-control">
            <option selected value="{{$employee[0]->upasamuha->id}}">{{$employee[0]->upasamuha->upasamuha_name}}
            </option>
        </select>
    </div>
    <div class="col-sm-2">
        <label for="shreni">श्रेणी :<sup>*</sup></label>
        <select readonly name="oper_rajinama_shreni" id="kaamkaj_shreni" class="form-control">
    ...
    <div class="col-sm-2">
        ...
        <select readonly name="oper_rajinama_taha" id="kaamkaj_taha" class="form-control">
...
<div class="row">
    ...
    <div class="form-group col-md-3 ">
        ...
        <select readonly name="oper_rajinama_ministry" id="ministry_id" class="form-control  dynamic"
            data-dependent='oper_rajinama_karyalaya_id'>
    ...
    <div class="col-md-3 ">
        <div class="form-group">
            ...
            <select readonly name="oper_rajinama_nirdeshanalaya" id="nirdeshanalaya_id" class="form-control ">
    ...
    <div class="col-md-3 ">
        <div class="form-group">
            ...
            <select readonly name="oper_rajinama_karyalaya" id="oper_rajinama_karyalaya_id"
                class="form-control  dynamic" data-dependent="oper_rajinama_pad_id">
    ...
    <div class="col-md-3 ">
        <div class="form-group">
            ...
            <select readonly name="oper_rajinama_pad" id="oper_rajinama_pad_id" class="form-control">
