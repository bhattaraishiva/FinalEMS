...
<div class="row">
    <div class="col-sm-2">
        ...
        <input type="text" class="form-control" name="oper_samayojan_appointed_date" nepali-calendar" id="nepaliDate5"
...
<div class="row">
    ...
    <div class="col-md-2 ">
        <div class="form-group">
            ...
            <select name="oper_samayojan_nirdeshanalaya" id="nirdeshanalaya_id" class="form-control ">
                <option selected value="{{$employee[0]->nirdeshanalaya['id']}}">
                    {{$employee[0]->nirdeshanalaya['nir_name']}}</option>
    ...
    <div class="col-md-2 ">
        <div class="form-group">
            ...
            <select name="oper_samayojan_karyalaya" id="oper_samayojan_karyalaya_id" class="form-control  dynamic"
                data-dependent="oper_samayojan_pad_id">
                <option selected value="{{$employee[0]->karyalaya['id']}}">{{$employee[0]->karyalaya['kar_name']}}
                </option>
            </select>
        </div>
    </div>
