...
<div class="form-group" id ="uniform-style">
    ...
    <div class="row" >
                <div class="col-md-3">
                <label for="name">नाम:</label><span >{{$employee->first_name}} {{$employee->middle_name}} {{ $employee->last_name}}</span>
                </div>
                <div class="col-md-3">
            ...
            <div class="row">            
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                                <div class="form-group">
                                        <label for="name">तह / श्रेणी :</label><span >{{$employee->taha['taha_name']}} / {{$employee->shreni['shreni_name']}}</span>
